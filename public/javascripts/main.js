...
/***/ "./node_modules/hyperapp-redux-devtools/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/hyperapp-redux-devtools/index.js ***!
  \*******************************************************/
...
var { createStore } = __webpack_require__(/*! redux */ "./node_modules/redux/es/index.js");
var { composeWithDevTools } = __webpack_require__(/*! redux-devtools-extension */ "./node_modules/redux-devtools-extension/index.js");
...
/* harmony import */ var hyperapp_redux_devtools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! hyperapp-redux-devtools */ "./node_modules/hyperapp-redux-devtools/index.js");
/* harmony import */ var hyperapp_redux_devtools__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(hyperapp_redux_devtools__WEBPACK_IMPORTED_MODULE_2__);
...
var appContainer = document.querySelector("#root > [data-app]");
var stateContainer = document.querySelector("#root > [data-state]");
var state = JSON.parse(stateContainer.innerHTML);

var view = function view(state, actions) {
  return Object(hyperapp__WEBPACK_IMPORTED_MODULE_1__["h"])("ul", {
    className: "list-group"
  }, state.films.map(function (film) {
    return Object(hyperapp__WEBPACK_IMPORTED_MODULE_1__["h"])("li", {
      className: "list-group-item"
    }, Object(hyperapp__WEBPACK_IMPORTED_MODULE_1__["h"])("a", {
      href: "/film/{film.id}",
      className: "btn btn-danger js-delete badge"
    }, "Delete"), Object(hyperapp__WEBPACK_IMPORTED_MODULE_1__["h"])("a", {
      className: "hideOverflow",
      href: "/film/{film.id}"
    }, film.name), Object(hyperapp__WEBPACK_IMPORTED_MODULE_1__["h"])("span", {
...
if (true) {
  main = hyperapp_redux_devtools__WEBPACK_IMPORTED_MODULE_2___default()(hyperapp__WEBPACK_IMPORTED_MODULE_1__["app"])(state, actions, view, appContainer);
} else {}

setTimeout(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.getJSON('/api/film', function (data) {
    state.films = data;
    console.log(state);
  });
}, 3000);
